        ...
        <div className="mx-auto flex min-h-screen flex-col items-center lg:flex-row">
          ...
          <div className="mb-5 flex w-full flex-col items-start justify-center text-left md:mb-0 lg:w-full lg:text-left">
            ...
            <p>
              ...
              the use of {Constants.webname}'s Website, located at https://
              {Constants.webname}
            ...
            <p>
              ...
              conditions. Do not continue to use {Constants.webname} if you do
            ...
            <p>
              We employ the use of cookies. By accessing {Constants.webname},
              you agreed to use cookies in agreement with the{' '}
              {Constants.webname}'s Privacy Policy.{' '}
            </p>
            ...
            <p>
              Unless otherwise stated, {Constants.webname} and/or its licensors
              own the intellectual property rights for all material on{' '}
              {Constants.webname}. All intellectual property rights are
              reserved. You may access this from {Constants.webname} for your
            ...
            <p>You must not:</p>
            <ul>
              <li>Republish material from {Constants.webname}</li>
              <li>
                Sell, rent or sub-license material from {Constants.webname}
              </li>
              <li>
                Reproduce, duplicate or copy material from {Constants.webname}
              </li>
              <li>Redistribute content from {Constants.webname}</li>
            </ul>
            ...
            <p>
              ...
              {Constants.webname} does not filter, edit, publish or review
              Comments prior to their presence on the website. Comments do not
              reflect the views and opinions of {Constants.webname},its agents
              ...
              by applicable laws, {Constants.webname}
            ...
            <p>
              {Constants.webname} reserves the right to monitor all Comments and
            ...
            <p>
              You hereby grant {Constants.webname} a non-exclusive license to
            ...
            <ul>
              ...
              <li>dot{Constants.tld} community sites;</li>
            ...
            <p>
              ...
              {Constants.webname}; and (d) the link is in the context of general
            ...
            <p>
              ...
              by sending an e-mail to {Constants.webname}. Please include your
            ...
            <p>
              No use of {Constants.webname}'s logo or other artwork will be
